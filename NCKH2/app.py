...
model = {
    'voting_classifier': pickle.load(open(r'C:\Users\Admin\OneDrive - uel.edu.vn\Documents\GitHub\Funny-Coder\NCKH2\trained_voting_classifier.pkl', 'rb')),
    'catboost_classifier': pickle.load(open(r'C:\Users\Admin\OneDrive - uel.edu.vn\Documents\GitHub\Funny-Coder\NCKH2\trained_catboost_classifier.pkl', 'rb'))
}
